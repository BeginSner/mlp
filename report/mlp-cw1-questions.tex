...
contrains the error(training and validation)by epoch, the the range of epoch is from 0 to 100. 
...
\begin{figure}[t]
    ...
    \begin{subfigure}{\linewidth}
        \includegraphics[width=\linewidth]{figures/one_hidden_layer_acc.png}
        \caption{accuracy by epoch}
        \label{fig:width_acccurves}
    \end{subfigure} 
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/one_hidden_layer_error.png}
...
\begin{figure}[t]
    \centering
    \begin{subfigure}{\linewidth}
        \includegraphics[width=\linewidth]{figures/multiple_layers_acc.png}
        \caption{accuracy by epoch}
        \label{fig:depth_acccurves}
    \end{subfigure} 
    \begin{subfigure}{\linewidth}
        \centering
        \includegraphics[width=\linewidth]{figures/multiple_layers_error.png}
        \caption{error by epoch}
